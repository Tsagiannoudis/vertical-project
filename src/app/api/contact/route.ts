...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Απλός έλεγχος για τα απαραίτητα πεδία
    ...
    // Γενικό σφάλμα αν κάτι άλλο πάει στραβά (π.χ. πρόβλημα με το request.json())
    return NextResponse.json({ message: 'Παρουσιάστηκε ένα σφάλμα κατά την επεξεργασία του αιτήματός σας.' }, { status: 500 });
  }
}