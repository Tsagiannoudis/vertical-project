                            ...
                            {index === 0 ? (
                                ...
                                <div className="relative w-52 h-52 mb-6">
                                    {/* Design 2: Concentric Circles */}
                                       <div className="absolute inset-0 bg-gradient-to-tr from-[#d4cbc2] to-[#d4cbc2] rounded-2xl transform transition-transform duration-300 ease-in-out group-hover:scale-105 group-hover:rotate-[-6deg]"></div>
